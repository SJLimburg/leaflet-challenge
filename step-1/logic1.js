...
function createEarthquakeLayer(earthquakeData) {
  ...
  // ==========create style function for onStyle and filter function for onFilter if wanted
  ...
  // This function sets up our markers for each point - I used the onStyle function to set the marker style 
